...
__decorate([
    (0, typeorm_1.ManyToOne)(() => document_entity_1.Document, (doc) => doc.approvals, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'document_id' }),
    __metadata("design:type", document_entity_1.Document)
], Approval.prototype, "document", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Approval.prototype, "reviewerId", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Approval.prototype, "reviewerName", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: enums_1.DocumentStatus }),
    __metadata("design:type", String)
